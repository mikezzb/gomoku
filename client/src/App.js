...
const App = () => {
  ...
  return (
    <div className="App">
            ...
            <div className="container">
              ...
              <div className="right">
                <form className="mainForm" onSubmit={e => setMode(e, true)}>
                  ...
                  />
                  <div>
                    <div className="submitButton" onClick={() => setMode(null, false)}>Play Offline Game</div>
                    <input className="submitButton" type="submit" value="Find Online Match!" />
                  </div>
                </form>
              </div>
            </div>
      ...
      <Board onlineMode={onlineMode} username={username} initialRoomno={roomno} />
    </div>
  );
};
